...
Симулятор торговли криптовалютой с портфелем, статистикой и визуальными графиками.
Проект построен на React + TypeScript + Vite с упором на UI/UX, доступность и адаптивность.
...
Приложение поднимется локально. Базовый URL API задаётся переменной окружения `VITE_API_URL`.
